...
init python:
    ...
    music_room.add(
        ...
        description=_("De {i}O Quebra-Nozes{/i}"),
...
screen music_room(mr):
    ...
    use game_menu(_("BÔNUS"), scroll="viewport"):
...
screen music_room2(mr):
    ...
    ## To return to the main menu
    textbutton _("Voltar") action Return() align (0.0, 1.0) text_size 40:
        left_margin 25 bottom_margin 25
        ...
        hbox:
            ...
            frame:
                ...
                viewport:
                    mousewheel True scrollbars "vertical" draggable True
                    has vbox
                    label _("Lista de Músicas") style "music_room_title" xalign 0.5
            ...
            vbox:
                ...
                if current_track:
                    ...
                    label _("Nenhuma música tocando")
...
screen music_room3(mr):
    ...
    ## you can use this:
    ##
    use game_menu(_("Sala de Música"))
    fixed:
        yfill True
