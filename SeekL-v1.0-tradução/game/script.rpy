...
default chat_location = "DIA 1 - CHAT"
...
label start:
    ...
    # $ chat_message("odxny: testando testando")
    # $ chat_message("wnpep: 12 x 4 = 48")
    # $ chat_message("wnpep: teste de aspas pronto \"olá, estou dentro de uma aspa 1 2 3\"")
    # $ chat_message("odxny: teste de código em linha")
    ...
    e "Você criou um novo jogo Ren'Py."

    e "Assim que você adicionar uma história, imagens e música, poderá lançá-lo para o mundo!"
