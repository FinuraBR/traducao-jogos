...
screen click_to_continue: 
    text "(clique para continuar)" color "#ffffff34" xalign 0.5 text_align 0.5 yalign 0.5 
...
screen credits_2: 
    vbox: 
        ...
        yalign 0.5 
        spacing 40
        text "robobarbie\n{color=9b9b9b}líder, programação, texto{/color}" xalign 0.5 text_align 0.5
        text "Allie Vera\n{color=9b9b9b}texto, edição{/color}" xalign 0.5 text_align 0.5
        text "saffeine_\n{color=9b9b9b}arte, programação{/color}" xalign 0.5 text_align 0.5
        text "Diantre' \"HI-T3C\" Butler\n{color=9b9b9b}música, sfx{/color}" xalign 0.5 text_align 0.5
        text "Mike Young\n{color=9b9b9b}atuação de voz{/color}" xalign 0.5 text_align 0.5
...
screen credits_4: 
    vbox: 
        ...
        yalign 0.5 
        spacing 40 
        text "{color=9b9b9b}EQUIPE DE QA{/color}" xalign 0.5 text_align 0.5
        text """Selendri
sleepythefoxx
Jeju
Autumn
...
screen credits_5: 
    text "Destini Islands\n{color=9b9b9b}agradecimento especial <3{/color}" xalign 0.5 yalign 0.5 text_align 0.5
...
init python:
    ...
    my_room.add(
        name=_("RAP TÓXICO FINAL FINAL 1 FINAL2"),
        path="audio/music/TOXIC_RAP.mp3",
        artist="odxny",
        #art="gui/music_room/nutcracker_ost.png",
        description=_("enviado às 2 da manhã"),
