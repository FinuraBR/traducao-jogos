    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton:
                ...
                hovered qtt.Action("Carregar")
                action Show('load')
            
            imagebutton:
                auto "gui/button/prefs_%s.png"
                hovered qtt.Action("Preferências")
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("INICIAR") action Play("sound", "audio/sfx/ui_start_game_001 start.ogg"), Start()

        else:

            textbutton _("HISTÓRICO") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), ShowMenu("history")

            textbutton _("SALVAR") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), ShowMenu("save")

        textbutton _("CARREGAR") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), ShowMenu("load")

        textbutton _("PREFERÊNCIAS") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), ShowMenu("preferences")

        textbutton _("GALERIA") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Show("gallery")

        if persistent.seekLove and persistent.seekLife and persistent.seekLoss: 

            textbutton _("BÔNUS") text_color character_colors["odxny"] text_hover_color gui.hover_color  action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Show("music_room", mr=my_room)
        else: 
            textbutton _("BÔNUS") action NullAction() text_color "#686868"
        ...
        if _in_replay:
            ...
            textbutton _("MENU PRINCIPAL") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), MainMenu()
        ...
        #     textbutton _("AJUDA") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), ShowMenu("help")

        if renpy.variant("pc"):

            ## The quit button is banned on iOS and unnecessary on Android and
            ## Web.
            textbutton _("SAIR") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Quit(confirm=not main_menu)
...
screen gallery():
    ...
    use game_menu("GALERIA"):
        #text "Página [gallery_page]" style "page_label_text" xalign 0.5 ypos 5
        hbox:
                style_prefix "page"
                ...
                if gallery_page=="1":
                    textbutton "{color=66cc00}buscar{/color}{color=b3b3af}Pesar{/color}": 
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","1")
                else: 
                    textbutton "buscar{color=b3b3af}Pesar{/color}": 
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","1")
                
                if gallery_page=="2": 
                    textbutton "{color=66cc00}buscar{/color}{color=ecde8f}Vida{/color}":
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","2")
                else:
                    textbutton "buscar{color=ecde8f}Vida{/color}":
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","2")
                
                if gallery_page=="3":
                    textbutton "{color=66cc00}buscar{/color}{color=f57cdf}Amor{/color}":
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","3")
                else:
                    textbutton "buscar{color=f57cdf}Amor{/color}":
                        action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), SetScreenVariable("gallery_page","3")
...
screen gallery_1:
    ...
    frame:
        ...
        #xsize 700
            ...
            #                 text "os tiras limparam todo o meu estoque de maconha mano eles levaram TUDO"
...
screen game_menu(title, scroll=None, yinitial=0.0):
    ...
    hbox at game_menu_popup:
        ...
        if not main_menu:
            ...
            textbutton _("HISTÓRICO") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Show("history")

            textbutton _("SALVAR") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Show("save")

        textbutton _("CARREGAR") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), Show("load")
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Página {}"), auto=_("Salvos Automáticos"), quick=_("Salvos Rápidos"))
    ...
    use game_menu(title):
        ...
        fixed:
                ...
                vbox: 
                    ...
                    for i in range(1 * 20):
                        ...
                        button:
                            ...
                            text FileTime(slot, format=_("{#file_time}%A, %d de %B de %Y, %H:%M"), empty=_("espaço vazio")):
            ...
            #         textbutton _(">") action FilePageNext()
                        ...
                        #textbutton _("Enviar Sincronização"):
                            #action UploadSync()
                            #xalign 0.5
                            #ypos 0.8
                    #else:
                        #textbutton _("Baixar Sincronização"):
                            #action DownloadSync()
                            #xalign 0.5
                            #ypos 0.8
...
screen history():
    ...
    use game_menu(_("HISTÓRICO")):#), scroll=("vpgrid_history" if gui.history_height else "viewport"), yinitial=1.0):
...
screen keyboard_help():
    ...
    hbox:
        label _("Tab")
        text _("Ativa/desativa o modo de pular diálogos.")

    hbox:
        label _("Page Up")
        text _("Retorna para diálogos anteriores.")
    ...
    hbox:
        label "V"
        text _("Ativa/desativa a {a=https://www.renpy.org/l/voicing}narração automática{/a} de acessibilidade.")
...
screen gamepad_help():
    ...
    hbox:
        label _("Botão de Ombro Direito")
        text _("Avança para diálogos posteriores.")
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("Sim") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), yes_action
                textbutton _("Não") action Play("sound", "audio/sfx/message_notification_02_002 tab.ogg"), no_action
